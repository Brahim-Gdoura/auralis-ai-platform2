...
class RAGSystem:
    def __init__(self, qa_chain, llm, vectorstore):
...
Response (SHORT and helpful):"""
    ...
    return RAGSystem(qa_chain, llm, vectorstore)
    #TODO FOR LATER: trigger embedding when running l code mouch when we send a msg + no need to search for chitchat 